...
ls.Fail.Ont <- list(Field = list(MAT     = c("MAT", "TYPE"),
                            TYPE     = c("TYPE", "MAT"),
                            LOCATION = c("LOCATION"),
                            COUNTY   = "LOCATION",
                            CITY     = "LOCATION",
                            ROAD     = "LOCATION",
                            ROUTE    = "LOCATION",
                            BRIDGE   = c("LOCATION", "STREAM"),
                            STREAM   = c("FEAT_UND", "LOCATION"),
                            BIN      = "BIN",
                            ID       = "ID"),
                    Clean = list(MAT     = c("MATER"),
                                 TYPE     = c("STRUCT_TYPE"),
                                 LOCATION = c("LOC"),
                                 COUNTY   = "LOC",
                                 CITY     = "LOC",
                                 ROAD     = "LOC",
                                 ROUTE    = "LOC",
                                 BRIDGE   = c("LOC", "STREAM_UNDER"),
                                 STREAM   = c("STREAM_UND", "LOC"),
                                 BIN      = "BIN_NUM",
                                 ID       = "ID"),
                    Feature = list(MAT      = "ITEM43A",
                                   TYPE     = "ITEM43B",
                                   LOCATION = c("LOC_AUX", "LOC_STREAM"),
                                   COUNTY   = c("COUNTY_NAME","FIPS"),
                                   CITY     = c("CITY_NAME","FIPS_CITY", "GNIS_ID", "ANSICODE"),
                                   ROAD     = c("ROAD_NAME", "ROAD_TYPE", "ROAD_AUX", "ROAD_DIR", "ITEM5C_ROAD"),
                                   ROUTE    = c("ROUTE_NAME", "ROUTE_TYPE", "ROUTE_AUX", "ROUTE_DIR", "ITEM5C_ROUTE"),
                                   BRIDGE   = c("LOCATION", "STREAM"),
                                   STREAM   = c("STREAM_NAME", "STREAM_TYPE", "STREAM_TRIB","STREAM_AUX","STREAM_LOC"),
                                   BIN      = "BIN_NUM",
                                   ID       = "ID"))
...
ls.NBI.Ont <- list(STFIPS   = c("STFIPS", "STATE_CODE_001", "ITEM1", "STATE_CODE_001", "ITEM98A", "OTHER_STATE_CODE_98A"),
                   ...
                   ROAD     = c('FACILITY_CARRIED_007', 'ROUTE_NUMBER_005D',"ITEM7", "ITEM5B", "ITEM5C" ),
                   ROUTE    = c('ROUTE_NUMBER_005D',  'ROUTE_PREFIX_005B',"ITEM5D", "ITEM5B", "ITEM5C"),
                   BRIDGE   = c('FACILITY_CARRIED_007',"ITEM7", "ITEM9"),
