...
## JURISDICTION, COUNTY, CITY, PLACE -----------------
  ...
  ls.CountyKeys <- list(prince_georges = c("prince georges","prince george's", "prince george s","prince george", 
                        ...
                        pottawattamie  = c("pottawattamie", "pott.", "pott"),
  ...
  ls.PlaceKeys <- list(village   = c("village", "villlage"),
                       ...
                       saint_petersburg = c("saint petersburg", "st. petersburg", "st petersburg"),
                       nicolaus       = c("nicolaus", "nicholaus"),
                       denison        = c("denison", "denisen"),
                       minneapolis    = c("minneapolis", "minneapols"))
